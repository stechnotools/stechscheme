  ...
  return {
    light: {
      palette: {
        ...
        text: {
          primary: `rgb(var(--mui-mainColorChannels-light) / 0.92)`,
          secondary: `rgb(var(--mui-mainColorChannels-light) / 0.72)`,
        ...
        background: {
          default: skin === 'bordered' ? '#FFF9F0' : '#F8F1E6',
          paper: '#FFFCF6',
          paperChannel: '255 252 246'
        },
        action: {
    ...
    dark: {
      palette: {
        ...
        background: {
          default: skin === 'bordered' ? '#1F1711' : '#17110C',
          paper: '#241A12',
          paperChannel: '36 26 18'
        },
        action: {
