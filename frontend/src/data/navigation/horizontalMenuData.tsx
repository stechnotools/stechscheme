  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { label: 'Add Branch', href: '/branches/add', permission: 'branches.add' },
    ...
    },
    {
      ...
      children: [
        { label: 'All Membership', href: '/membership/active', permission: 'membership.active' },
        { label: 'Create Membership', href: '/membership/create', permission: 'membership.create' }
      ]
    },
    {
      label: 'Feedback',
    ...
    },
    {
      ...
      children: [
        ...
        { label: 'WhatsApp API', href: '/settings/whatsapp-api', permission: 'settings.whatsapp-api' },
